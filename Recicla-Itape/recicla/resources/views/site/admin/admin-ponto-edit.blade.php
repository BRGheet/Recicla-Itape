	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body">
    		...
    		<form id="upload" enctype="multipart/form-data">
            	...
            	<input class="form-control" id="id" type="text" name="id" value="{{ $ponto->id }}" readonly>
            	<br>
			    <label for="nome">Nome da cooperativa</label><span class="font-red">*</span>
				<input id="nome" type="text" name="nome"  class="form-control" value="{{ $ponto->name }}">
				<br>
				<label for="descricao">Descrição</label><span class="font-red">*</span>
				<textarea id="descricao" class="form-control" name="descricao">{{ $ponto->content }}</textarea>
				<br>
				<label for="endereco">Endereço</label><span class="font-red">*</span>
				<input id="endereco" type="text" name="endereco" class="form-control" value="{{ $ponto->address }}">
				<br>
				<label for="lat">Latitude</label><span class="font-red">*</span>
				<input id="lat" type="text" name="latitude" placeholder="Latitude do local: " class="form-control" value="{{ $ponto->lat }}">
				<br>
				<label for="lng">Longitude</label><span class="font-red">*</span>
				<input id="lng" type="text" name="longitude" placeholder="Longitude do local: " class="form-control" value="{{ $ponto->lng }}">
